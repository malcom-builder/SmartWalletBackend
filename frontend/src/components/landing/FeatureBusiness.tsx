import { Briefcase, Link as LinkIcon, QrCode, TrendingUp } from "lucide-react";
      ...
      <div className="container mx-auto px-4 md:px-6 h-full flex flex-col justify-center min-h-0 max-h-[800px]">
        ...
        <div className="flex flex-col items-center text-center mb-6 md:mb-10">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/10 bg-white/5 text-[10px] md:text-xs font-sora font-semibold text-white tracking-widest uppercase mb-4">
            ...
            SmartWallet for Business
          </div>
          <h2 className="font-syne font-extrabold text-3xl md:text-5xl text-white tracking-tight">
            Built for <span className="text-white/30">Entrepreneurs.</span>
          </h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6 max-w-5xl mx-auto mb-6 md:mb-10 w-full">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl md:rounded-3xl p-4 md:p-8 hover:border-white/20 transition-colors flex flex-col items-center text-center">
            ...
            <h4 className="font-syne font-bold text-base md:text-xl text-white mb-2">Payment Links</h4>
            <p className="font-sora text-medium-zinc text-xs md:text-sm leading-relaxed">
              Generate custom payment links and share them via WhatsApp. Accept payments worldwide instantly.
            </p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl md:rounded-3xl p-4 md:p-8 hover:border-white/20 transition-colors flex flex-col items-center text-center">
            ...
            <h4 className="font-syne font-bold text-base md:text-xl text-white mb-2">QR Payments</h4>
            <p className="font-sora text-medium-zinc text-xs md:text-sm leading-relaxed">
              Display your business QR code at your physical store. Customers scan and pay directly from any wallet.
            </p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl md:rounded-3xl p-4 md:p-8 hover:border-white/20 transition-colors flex flex-col items-center text-center">
            ...
            <h4 className="font-syne font-bold text-base md:text-xl text-white mb-2">Instant Credits</h4>
            <p className="font-sora text-medium-zinc text-xs md:text-sm leading-relaxed">
              Access working capital loans based on your sales volume. Approve in minutes, fund your growth.
            </p>
          </div>
